...
export const metadata: Metadata = {
  ...
  description:
    "B'LURU Fresh delivers farm-fresh chicken in Yelahanka, Bangalore. Order boneless, curry cut, drumsticks & more — cut fresh after your order, no preservatives, delivered in ~45 mins. FSSAI licensed (11226331000344).",
  keywords: [
    "blurufresh",
    "bluru fresh",
    "bluru fresh chicken",
  ...
  openGraph: {
    ...
    description:
      "Farm-fresh chicken order to cut, delivered in ~45 mins across Yelahanka & Bangalore. No preservatives, FSSAI certified.",
  ...
  twitter: {
    ...
    description: 'Fresh chicken order to cut, delivered in ~45 mins. No preservatives. Order now!',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Farm-fresh chicken order to cut and delivered in ~45 minutes across Yelahanka, Bangalore. No preservatives, FSSAI certified.",
              ...
              "additionalProperty": [
                ...
                { "@type": "PropertyValue", "name": "Delivery Time", "value": "~45 minutes" },
