...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${outfit.variable} ${playfair.variable} ${fraunces.variable} ${montserrat.variable}  ${spaceGrotesk.variable}`}
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Lilita+One&family=Unbounded:wght@400;700;900&family=Outfit:wght@300;400;500;600;700;800;900&display=swap"
          rel="stylesheet"
        />
            ...
            __html: JSON.stringify([
              {
                ...
                address: {
                  "@type": "PostalAddress",
                  streetAddress:
                    "No. 951, Thirumenahalli Main Road, Agrahara Layout",
                    ...
                    hasMenuItem: [
                      {
                        ...
                        description:
                          "Fresh curry cut chicken, cut after your order — perfect for everyday curries and gravies.",
                      },
                      {
                        "@type": "MenuItem",
                        name: "Boneless Chicken",
                        description:
                          "Fresh boneless chicken, cut after your order — ideal for biryani, fry and tikka.",
                      },
                      {
                        "@type": "MenuItem",
                        name: "Chicken Drumstick",
                        description:
                          "Fresh chicken drumsticks, cut after your order.",
                      },
                      {
                        "@type": "MenuItem",
                        name: "Chicken Wings",
                        description:
                          "Fresh chicken wings, cut after your order.",
                      },
                      {
                        "@type": "MenuItem",
                        name: "Chicken Liver & Other",
                        description:
                          "Fresh chicken liver and other parts, packed after your order.",
                      },
                    ],
                  },
                },
                ...
                additionalProperty: [
                  ...
                  },
                  {
                    "@type": "PropertyValue",
                    name: "Preservatives",
                    value: "None — Zero preservatives",
                  },
                  {
                    "@type": "PropertyValue",
                    name: "Cutting Policy",
                    value: "Cut only after order is placed",
                  },
                ],
              },
              {
